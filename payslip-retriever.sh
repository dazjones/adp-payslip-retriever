...
usage() {
  ...
  echo "      directory to write the payslip pdf"
  echo
  echo "  -v, --verbose"
...
[ -z "${OUT_FILE+x}" ] && fail "output directory is unset. Use --help for usage instructions"
...
OUT_FILE="$OUT_FILE/ADP-${PAYSLIP_DATE}-AUTO_DOWNLOAD.pdf"
